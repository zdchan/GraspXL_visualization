...
def axisangle2mat(rot_vecs, epsilon: float = 1e-8):
...
def construct_meshes_per_object(obj_key, raw_data, set_color, obj_name, ambient_object, use_texture=False):
    ...
    joint_list = [
        ...
        "FFJ4", "FFJ3", "FFJ2", "FFJ1", "MFJ4", "MFJ3", "MFJ2", "MFJ1",
        "RFJ4", "RFJ3", "RFJ2", "RFJ1", "LFJ5", "LFJ4", "LFJ3", "LFJ2", "LFJ1",
        "THJ5", "THJ4", "THJ3", "THJ2", "THJ1"
    ]

    # 每个 link 的顶点数
    link_vert_counts = [3477, 8, 746, 207, 297, 297, 297, 297, 8, 549, 549, 549, 549, 633, 224, 224, 224, 224, 486, 166, 486, 166, 486]
